	...
	<div class="row"><br><br>
	    <div class="col-md-10 col-md-offset-0">
	        <div class="panel panel-success">
	            <div class="panel-heading"><center><h2> TUNJANGAN </h2></center></div>

	            	<div class="panel-body">
					<a href="<?php echo e(url('/tunjangan/create')); ?>" class="btn btn-success"> Tambah Tunjangan </a>
					<hr>
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td> <a href="<?php echo e(route('tunjangan.edit', $data->id)); ?>" class="btn btn-warning"> Update </a></td>
								<td>
