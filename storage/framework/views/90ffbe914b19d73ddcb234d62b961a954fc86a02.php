				...
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							...
							<a href="<?php echo e(url('/jabatan')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular"><i class="fa fa-group fa-3x"></i></h4>
							<a href="<?php echo e(url('/golongan')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							...
							<a href="<?php echo e(url('/kategorilembur')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular"><i class="fa fa-clock-o fa-3x"></i></h4>
							<a href="<?php echo e(url('/lemburpegawai')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							...
							<a href="<?php echo e(url('/tunjangan')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular"><i class="fa fa-dollar fa-3x"></i></h4>
							<a href="<?php echo e(url('/tpegawai')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							...
							<a href="<?php echo e(url('/penggajian')); ?>" class="btn btn-white-fill expand">Lihat</a>
						</div>
					</div>
				</div>
			</div>
